...
> 「何であって何でないか」「Freeが主張してはならないこと」「未入力・取得失敗・医療広告リスクの原則」
> 「コピーライティングのガードレール」「ロードマップ」を定義しています。
...
- **医療広告リスク** … 文脈により確認が望ましい表現の初期スクリーニング（断定はしない）
...
本サービスの医療広告リスク診断は、**単語ベースの初期スクリーニング** です。以下の限界を理解してご利用ください。
