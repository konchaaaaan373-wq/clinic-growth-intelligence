...
// スコアは達成率ベースの0〜100点。単位表記は凡例と同じ「点」に統一する
const GRADE_MEANING: Record<"A" | "B" | "C" | "D", string> = {
  A: "外から見える導線は良好。次は実データで磨く段階（80点以上）",
  B: "基本はしっかり。あと少し整えると強い（60〜79点）",
  C: "整えどき。伸びしろがはっきり見えている状態（40〜59点）",
  D: "伸びしろが大きい状態。基本の導線づくりから始める段階（39点以下）",
};
